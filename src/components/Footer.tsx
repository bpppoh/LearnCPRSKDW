        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs text-slate-600">
              <li>1. นาย กิตติพัฒน์ โตเลี้ยง (เลขที่ 1)</li>
              <li>2. ด.ช. คุณานนท์ อุนทุโร (เลขที่ 4)</li>
              <li>3. นาย ธนาธิป ตั้งศุภธวัช (เลขที่ 7)</li>
              <li>4. ด.ญ. กัญญาพัชร ลือยาม (เลขที่ 16)</li>
              <li>5. ด.ญ. ไอลดา พิณทอง (เลขที่ 18)</li>
              <li>6. ด.ญ. นันท์นภัส แดงบุญมี (เลขที่ 25)</li>
            </ul>
            <div className="mt-3">
              <button
